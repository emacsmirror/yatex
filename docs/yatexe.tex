...
@c Last modified Fri Dec 22 09:50:10 2000 on buell
@syncodeindex vr cp
@end iftex
...
@title Wild Bird
@subtitle // YaTeX //
@author @copyright{} 1991-1996 by    HIROSE, Yuuji [yuuji@@yatex.org]
@end titlepage
...
If you use LaTeX2e, set to @code{t} (@code{nil})
@end defvar
...
(up to Dec.2000 at least)  And there is mailing list for YaTeX.
