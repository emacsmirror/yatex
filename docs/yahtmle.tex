...
@c Do people really read this INFO?
@c Still not finished
@c Last modified Mon Nov 29 16:01:00 1999 on buell
@syncodeindex vr cp
@end iftex
...
@c @item @code{\include(\input)} Å® ëŒâûÇ∑ÇÈÉtÉ@ÉCÉã
@end itemize
...
Elements that @code{<p>} will be automatically inserted. @code{^\(body\|dl\)}
@end defvar
...
to yuuji@@yatex.orgÅ@(as of July 1999)
...
section of @file{docs/yahtmlqa} in this package.
