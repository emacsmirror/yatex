...
@c Last modified Thu Mar 16 01:04:48 2000 on firestorm
@syncodeindex vr cp
@end iftex
...
@title 『野鳥』
@subtitle // YaTeX //
@author @copyright{} 1991-1999 by    HIROSE, Yuuji [yuuji@@yatex.org]
@end titlepage
...
LaTeX2e を使用する場合は @code{t} に設定する (@code{nil})
@end defvar
...
連絡は yuuji@@yatex.org まで(1999年8月現在)。
